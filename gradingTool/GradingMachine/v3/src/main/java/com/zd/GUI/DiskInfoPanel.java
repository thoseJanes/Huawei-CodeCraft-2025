...
public class DiskInfoPanel extends JPanel {
    ...
    public DiskInfoPanel(int DiskId,int DiskHead,int UnitId,int Object,int Tag,int RequestNums,double Score){
        ...
        Head = new JTextArea(String.format("Head: %d",this.DiskHead));
    ...
    public void updateParams(int DiskId,int DiskHead,int UnitId,int Object,int Tag,int RequestNums,float Score){
        this.DiskId = DiskId;
        this.DiskHead = DiskHead;
        this.UnitId = UnitId;
        this.Object = Object;
        ...
        Head.setText(String.format("Head: %d",this.DiskHead));
    ...
    public static void main(String[] args){
        EventQueue.invokeLater(()->{
            ...
            DiskInfoPanel panel = new DiskInfoPanel(6,1,275,0,0,0,0);
            frame.add(panel);

            panel.updateParams(5,1,275,0,0,0,0);
